...
const experienceItems = [
  {
    ...
    description: [
      `Implementation of Project Permissions experince to be offered in a newly created Pro Workspace plan, enabling more granular permissions (Design, Content and Publish) to editors for each project, also creating protections in the backend to assure security and compliance.`,
