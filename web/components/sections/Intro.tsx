  ...
  return (
    <section id="introduction">
      ...
      <style jsx>{`
        ...
        a,
        h5 {
          color: ${colors.light.base_medium_color};
        }

        @media (prefers-color-scheme: dark) {
          a,
          h5 {
            color: ${colors.dark.base_medium_color};
          }
        }
